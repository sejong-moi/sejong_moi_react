      ...
      <div className={styles.inner}> 
          <form method="post" enctype="multipart/form-data">
            ...
            <div className= {styles.element}>
              ...
              <textarea  type="text" id="introduce" maxLength={50}  className={styles.text}  onChange={(e) => changeAns(e)}></textarea >
            </div>
            <div className= {styles.element}>
              <label id="introduce_long">동아리 소개글</label>
              <textarea  type="text" id="introduce_long" className={styles.text} onChange={(e) => changeAns(e)}></textarea >
            </div>
            <div className= {styles.element}>
            ...
            <div className= {styles.element}>
              ...
              <div className={styles.ques}>
               ...
               <input type="text" id="recruit" onChange={(e) => changeAns(e)} placeholder="직접입력) XXXX/XX/XX"/>
